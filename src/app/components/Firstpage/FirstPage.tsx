...
return (
	...
	<div className={styles.upperPart}>
			...
			<h5>Desenvolvido com dados de observação da Terra da Nasa para o Hackathon Brasil</h5>
	...
	<div className={styles.middle_upperPart}>
			<div className={styles.grid}>
					...
					<div className={styles.bottomPart_square}>
						...
						<p>O ClimaCerto utiliza décadas de dados de observação da Terra da NASA para fornecer informações sobre a probabilidade de condições climáticas específicas em qualquer localização e época do ano</p>
						<p>Diferente de previsões meteorológicas, nosso sistema analisa dados históricos para determinar as chances de condições extremas como: calor intenso, frio extremo, ventors fortes, chuvas intensas ou condições desconfortáveis</p>
						<b>Planeje suas atividades ao ar livre com confiança, sabendo exatamente quais são as probabilidade climáticas para o local e data escolhidos.</b>
					</div>
	</>
	);
};
